[CYT-160-Project2-Revised-Final-bfac] Operating Details
====================================

Generated On: 2024-11-07 21:16:03 UTC
...
.. important::
   ...
   **not be valid if your [CYT-160-Project2-Revised-Final-bfac] container is NOT running**.

.. tip::
   You must have your [CYT-160-Project2-Revised-Final-bfac] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/kalpit10/rasberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=36985  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='kalpit10'  \-\-env DOCKERUSERNAME='kalpit10'  \-\-env MQTTUSERNAME='kalpit.swami@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kalpit10/CYT-160-Project2-Revised-Final-bfac-amd64 (https://hub.docker.com/r/kalpit10/CYT-160-Project2-Revised-Final-bfac-amd64)
...
.. important::
   docker run -d -p 50861:50861 -p 53879:53879 -p 35257:35257 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=CYT-160-Project2-Revised-Final-bfac \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-CYT-160-Project2-Revised-Final-bfac \-\-env GITUSERNAME=kalpit10  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi \-\-env SOLUTIONEXTERNALPORT=50861  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53879  \-\-env SOLUTIONVIPERVIZPORT=35257 \-\-env DOCKERUSERNAME='kalpit10' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=36985 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='kalpit.swami@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kalpit10/CYT-160-Project2-Revised-Final-bfac-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=35257
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=50861
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kalpit10/CYT-160-Project2-Revised-Final-bfac-amd64
...
It can be accessed by entering: http://localhost:53879
...
.. important::
   http://localhost:35257/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:35257/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:35257/<html file>
...
[CYT-160-Project2-Revised-Final-bfac] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/kalpit10/rasberrypi/tree/main/tml-airflow/dags/tml-solutions/CYT-160-Project2-Revised-Final-bfac
...
.. important::
   https://CYT-160-Project2-Revised-Final-bfac.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-CYT-160-Project2-Revised-Final-bfac
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=50861, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=41803, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=40671, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41007, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36299, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45455, HPDEHOST=127.0.1.1, HPDEPORT=42235, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34299

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5083-CYT-160-Project2-Revised-Final-bfac,solution_preprocessing_ai_mqtt_dag-CYT-160-Project2-Revised-Final-bfac, python-preprocess-2297-CYT-160-Project2-Revised-Final-bfac,solution_preprocessing_ai_mqtt_dag-CYT-160-Project2-Revised-Final-bfac, python-ai-2452-CYT-160-Project2-Revised-Final-bfac,solution_preprocessing_ai_mqtt_dag-CYT-160-Project2-Revised-Final-bfac, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
